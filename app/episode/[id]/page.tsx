...
export default function EpisodePage({ initialCollected = false }) {
      ...
      <div className="flex items-start space-x-6 mb-8">
        ...
        <div className="flex-1">
          ...
          <div className="flex items-center space-x-4">
            ...
            {/* 播放按钮 */}
            <button className="flex items-center px-4 py-1 bg-slate-200 text-xs text-gray-500 rounded-lg hover:bg-slate-300 transition-colors">
              <svg
                className="w-5 h-5 mr-2"
                viewBox="0 0 24 24"
                fill="currentColor"
